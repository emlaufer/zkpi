...
impl ZkInput {
    ...
    fn compress(&mut self) {
        ...
        self.proving_rule = pivote[self.proving_rule];
    }
    ...
    pub fn export_ty(
        ...
        let zk_rule = match input.kind {
            ...
            EXPR_AX => {
                ...
                let lift_rule = self.export_lift(term, max_binding, ExpTerm::MAX_BINDING);
